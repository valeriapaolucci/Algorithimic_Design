...
void improved2_strassen_aux(float **C, const size_t C_f_row, const size_t C_f_col,
               ...
               const size_t n)
{
  ...
  // P5 = S5 x S6
  improved2_strassen_aux(P[0], 0, 0,
               S[0], 0, 0,
               S[1], 0, 0,
               n2);
  ...
  // P4 = A22 x S4
  improved2_strassen_aux(P[1], 0, 0,
               A, A2X, AX2,
               S[0], 0, 0,
               n2);
  ...
  // P2 = S2 x B22
  improved2_strassen_aux(P[2], 0, 0,
               S[0], 0, 0,
               B, B2X, BX2,
               n2);
  ...
  // P6 = S7 x S8
  improved2_strassen_aux(P[3], 0, 0,
               S[0], 0, 0,
               S[1], 0, 0,
               n2);
...
void improved2_strassen(float **C, float **A, float **B, const size_t n)
{
  improved2_strassen_aux(C, 0, 0, A, 0, 0, B, 0, 0, n);
}